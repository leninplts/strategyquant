...
# REQUISITO en host ARM64: QEMU user-mode debe estar funcional.
# Si vez "unsupported filetype" en los keyrings o "Segmentation fault"
# durante el build, ejecuta en el host:
#   sudo bash fix-qemu-sigsegv.sh
# Eso baja vm.mmap_min_addr=0 que es lo que QEMU user-mode necesita
# para emular x86_64 sobre ARM64 sin crashear.
